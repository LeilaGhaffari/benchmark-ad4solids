...
void kirchhofftau_tapenade_(const double lambda, const double mu, double e_sym[6], double tau_sym[6]);
void dtau_fwd_tapenade_(const double lambda, const double mu, double e_sym[6], double de_sym[6], double tau_sym[6], double dtau_sym[6]);
